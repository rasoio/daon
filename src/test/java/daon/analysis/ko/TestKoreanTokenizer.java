...
import daon.analysis.ko.dict.ConnectionCosts;
import daon.analysis.ko.dict.UserDictionary;
import daon.analysis.ko.tokenattributes.BaseFormAttribute;
import daon.analysis.ko.tokenattributes.InflectionAttribute;
import daon.analysis.ko.tokenattributes.PartOfSpeechAttribute;
import daon.analysis.ko.tokenattributes.ReadingAttribute;
  ...
  public void setUp() throws Exception {
    ...
    analyzer = new Analyzer() {
      ...
      protected TokenStreamComponents createComponents(String fieldName) {
        Tokenizer tokenizer = new KoreanTokenizer(newAttributeFactory(), readDict(), false, Mode.SEARCH);
    ...
    analyzerNormal = new Analyzer() {
      @Override
      protected TokenStreamComponents createComponents(String fieldName) {
        Tokenizer tokenizer = new KoreanTokenizer(newAttributeFactory(), readDict(), false, Mode.NORMAL);
        return new TokenStreamComponents(tokenizer, tokenizer);
      }
    };
    analyzerNoPunct = new Analyzer() {
      @Override
      protected TokenStreamComponents createComponents(String fieldName) {
        Tokenizer tokenizer = new KoreanTokenizer(newAttributeFactory(), readDict(), true, Mode.SEARCH);
        return new TokenStreamComponents(tokenizer, tokenizer);
      }
    };
    extendedModeAnalyzerNoPunct = new Analyzer() {
      @Override
      protected TokenStreamComponents createComponents(String fieldName) {
        Tokenizer tokenizer = new KoreanTokenizer(newAttributeFactory(), readDict(), true, Mode.EXTENDED);
        return new TokenStreamComponents(tokenizer, tokenizer);
      }
    };
  }
  ...
  */
  ...
  public void testLatticeToDot() throws Exception {
    ...
    final Analyzer analyzer = new Analyzer() {
      @Override
      protected TokenStreamComponents createComponents(String fieldName) {
        KoreanTokenizer tokenizer = new KoreanTokenizer(newAttributeFactory(), readDict(), false, Mode.SEARCH);
