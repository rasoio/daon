...
import daon.analysis.ko.util.CSVUtil;
...
//      System.out.println("output=" + output);
      ...
      for (int i = 0; i < remaining; i++) {
        ...
        System.out.println(chars[startOffset+i]);
        ...
        if (arc.isFinal()) {
          ...
          System.out.println("segmentations=" + getReading(segmentations[finalOutput][0], "日本".toCharArray(), 0, 1));
