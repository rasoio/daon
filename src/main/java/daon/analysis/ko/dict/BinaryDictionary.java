...
public abstract class BinaryDictionary implements Dictionary {
  ...
  protected BinaryDictionary() throws IOException {
    ...
    System.out.println("inflFormDict size=" + inflFormDict.length);
    System.out.println("inflTypeDict size=" + inflTypeDict.length);
    System.out.println("posDict size=" + posDict.length);
    System.out.println("targetMap size=" + targetMap.length);
//    for(String d : inflFormDict){
