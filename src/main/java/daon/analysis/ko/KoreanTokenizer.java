...
import daon.analysis.ko.dict.CharacterDefinition;
import daon.analysis.ko.dict.ConnectionCosts;
import daon.analysis.ko.dict.Dictionary;
import daon.analysis.ko.dict.TokenInfoDictionary;
import daon.analysis.ko.dict.UnknownDictionary;
import daon.analysis.ko.dict.UserDictionary;
import daon.analysis.ko.dict.TokenInfoFST;
import daon.analysis.ko.tokenattributes.*;
...
public final class KoreanTokenizer extends Tokenizer {
   ...
   */
  public KoreanTokenizer(UserDictionary userDictionary, boolean discardPunctuation, Mode mode) {
