 ...
 */
package lucene.core.util;


import java.util.Arrays;
import java.util.concurrent.atomic.AtomicLong;

import lucene.core.util.ByteBlockPool.DirectAllocator;

import static lucene.core.util.ByteBlockPool.BYTE_BLOCK_MASK;
import static lucene.core.util.ByteBlockPool.BYTE_BLOCK_SHIFT;
import static lucene.core.util.ByteBlockPool.BYTE_BLOCK_SIZE;
