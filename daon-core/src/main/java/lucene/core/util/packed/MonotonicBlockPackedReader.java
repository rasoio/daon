...
import static lucene.core.util.packed.AbstractBlockPackedWriter.MAX_BLOCK_SIZE;
import static lucene.core.util.packed.AbstractBlockPackedWriter.MIN_BLOCK_SIZE;

import java.io.IOException;

import lucene.core.util.LongValues;
...
public class MonotonicBlockPackedReader extends LongValues implements Accountable {
  ...
  private MonotonicBlockPackedReader(IndexInput in, int packedIntsVersion, int blockSize, long valueCount, boolean direct) throws IOException {
    ...
    blockShift = PackedInts.checkBlockSize(blockSize, MIN_BLOCK_SIZE, MAX_BLOCK_SIZE);
