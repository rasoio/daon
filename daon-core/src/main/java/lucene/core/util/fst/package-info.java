 ...
 *    <li>Optional two-pass compression: {@link lucene.core.util.fst.FST#pack FST.pack()}</li>
 *    <li>{@link lucene.core.util.fst.Util#getByOutput Lookup-by-output} when the
 *        outputs are in sorted order (e.g., ordinals or file pointers)</li>
 *    <li>Pluggable {@link lucene.core.util.fst.Outputs Outputs} representation</li>
 *    <li>{@link lucene.core.util.fst.Util#shortestPaths N-shortest-paths} search by
 *        weight</li>
 *    <li>Enumerators ({@link lucene.core.util.fst.IntsRefFSTEnum IntsRef} and {@link lucene.core.util.fst.BytesRefFSTEnum BytesRef}) that behave like {@link java.util.SortedMap SortedMap} iterators
 * </ul>
 * <p>
