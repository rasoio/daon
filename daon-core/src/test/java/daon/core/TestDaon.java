...
//        String sentence = "을"; // 쫀쫀, 쫀핏 (unknown). connection null...
//        String sentence = "자연스러운"; // 쫀쫀, 쫀핏 (unknown). connection null...
//        String sentence = "흘러들어가"; // 쫀쫀, 쫀핏 (unknown). connection null...
...
//        String sentence = "미쁜14K/18K MIPP-DG35 커플링".toLowerCase();
        String sentence = "[����대━�� �щ┝+濡��+����� 留���깊�遺���⑹�".toLowerCase();
//        String sentence = "bcbg포스팅스커트";
