...
public class TestUtils {
    ...
    public void testNoCoda() throws JsonParseException, JsonMappingException, IOException {
        ...
        Assert.assertFalse(Utils.endWithNoJongseong(new Keyword("가난", POSTag.NNG)));
        Assert.assertFalse(Utils.endWithNoJongseong(new Keyword("124", POSTag.NNG)));
        Assert.assertFalse(Utils.endWithNoJongseong(new Keyword("124ab", POSTag.NNG)));
    ...
    public void testStartWith() throws JsonParseException, JsonMappingException, IOException {
        ...
        Assert.assertTrue(Utils.startsWithChoseong(new Keyword("바보", POSTag.NNG), new char[]{'ㅂ'}));
        Assert.assertTrue(Utils.startsWithChoseong(new Keyword("으니", POSTag.NNG), new char[]{'ㅇ'}));

        Assert.assertTrue(Utils.startsWith(new Keyword("아", POSTag.NNG), new char[]{'ㅇ'}, new char[]{'ㅏ'}, Utils.JONGSEONG));
        Assert.assertFalse(Utils.startsWith(new Keyword("아", POSTag.NNG), new char[]{'ㅇ'}, new char[]{'ㅏ'}, Utils.removeElement(Utils.JONGSEONG, new char[]{'\0'})));
        Assert.assertTrue(Utils.startsWith(new Keyword("답", POSTag.NNG), new char[]{'ㄷ', 'ㄲ', 'ㄱ', 'ㄴ', 'ㅁ', 'ㄸ'}, new char[]{'ㅏ'}, new char[]{'ㅂ'}));
        Assert.assertTrue(Utils.startsWith(new Keyword("다", POSTag.NNG), new char[]{'ㄷ', 'ㄲ', 'ㄱ', 'ㄴ', 'ㅁ', 'ㄸ'}, new char[]{'ㅏ'}, new char[]{'\0'}));
    }
    ...
    public void testEndWith() throws JsonParseException, JsonMappingException, IOException {
        ...
        Assert.assertTrue(Utils.endWithChoseong(new Keyword("바보", POSTag.NNG), new char[]{'ㅂ'}));
        Assert.assertTrue(Utils.endWithChoseong(new Keyword("니은", POSTag.NNG), new char[]{'ㅇ'}));

        Assert.assertTrue(Utils.endWith(new Keyword("아", POSTag.NNG), new char[]{'ㅇ'}, new char[]{'ㅏ'}, Utils.JONGSEONG));
        Assert.assertFalse(Utils.endWith(new Keyword("아", POSTag.NNG), new char[]{'ㅇ'}, new char[]{'ㅏ'}, Utils.removeElement(Utils.JONGSEONG, new char[]{'\0'})));
        Assert.assertTrue(Utils.endWith(new Keyword("답", POSTag.NNG), new char[]{'ㄷ', 'ㄲ', 'ㄱ', 'ㄴ', 'ㅁ', 'ㄸ'}, new char[]{'ㅏ'}, new char[]{'ㅂ'}));

        Assert.assertTrue(Utils.endWith(new Keyword("다", POSTag.NNG), new char[]{'ㄷ', 'ㄲ', 'ㄱ', 'ㄴ', 'ㅁ', 'ㄸ'}, new char[]{'ㅏ'}, new char[]{'\0'}));
    ...
    public void testGetCharAtDecompose() throws JsonParseException, JsonMappingException, IOException {
        ...
        char[] c3 = Utils.getCharAtDecompose(new Keyword("간다", POSTag.NNG), -3);


        char[] c4 = Utils.getCharAtDecompose(new Keyword("간다", POSTag.NNG), 0);
        char[] c5 = Utils.getCharAtDecompose(new Keyword("간다", POSTag.NNG), 1);
        char[] c6 = Utils.getCharAtDecompose(new Keyword("간다", POSTag.NNG), 2);
    ...
    public void testMatch() throws JsonParseException, JsonMappingException, IOException {
        ...
        char[] c2 = Utils.getCharAtDecompose(new Keyword("간다", POSTag.NNG), -2);
        char[] c3 = Utils.getCharAtDecompose(new Keyword("간다", POSTag.NNG), -3);// empty
