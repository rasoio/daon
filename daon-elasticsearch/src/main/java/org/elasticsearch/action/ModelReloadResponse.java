...
public class ModelReloadResponse extends ActionResponse implements StatusToXContentObject {
    ...
    public ModelReloadResponse(String clusterName, String[] concreteIndices, ClusterState clusterState) {
        this(clusterName, concreteIndices, clusterState, -1, -1, -1, TimeValue.timeValueHours(0));
    }

    public ModelReloadResponse(String clusterName, String[] concreteIndices, ClusterState clusterState, int numberOfPendingTasks,
    ...
    public static ModelReloadResponse readResponseFrom(StreamInput in) throws IOException {
        ModelReloadResponse response = new ModelReloadResponse();
