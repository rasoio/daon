<template>
  <md-layout class="container-pad-top">
    ...
    <sentence-form ref="sentenceForm"></sentence-form>
  ...
  export default {
    ...
    methods : {
      openDialog: function(id, index) {
        this.$refs.sentenceForm.openDialog(id, index);
      },
      search: function (size = 10, page = 1) {
        ...
        let condition = vm.searchFilter.condition;
        let indices = vm.searchFilter.indices;
...
//        }
        ...
        this.$http.post('/v1/sentence/search', params)
